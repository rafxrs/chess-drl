...
class GUI:
    ...
    def draw(self):
        ...
        self.gameboard.selected_square = self.from_square
    ...
    def move_piece(self, piece: chess.PieceType) -> None:
        # move piece to to_square
        # create san from move
        try:
            from_square = Board.square_to_string(
                Board.tuple_to_square(*self.from_square))
            to_square = Board.square_to_string(
                Board.tuple_to_square(*self.to_square))
